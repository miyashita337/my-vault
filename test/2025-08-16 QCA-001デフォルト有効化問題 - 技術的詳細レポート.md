 ...
 発覚した問題:
  - 2025年8月10日11:29:36以降の全31トラッカーで複合オプション（QCA-001 + SAM最適化）が意図せず有効化
  - 「ベースライン」として実行したつもりの実験がすべて「複合オプション有効」状態
  - 過去6日間の統計分析・品質比較データがすべて無効

  確認質問:
  1. この影響範囲の認識で間違いありませんか？
はい
  2. 他に重要なトラッカーや実験で影響を受けるものはありますか？
ない
  ...
  無効になった可能性のあるデータ:
  - Enhanced Cohen's d 統計分析
  - COMPOSITE vs BASELINE 品質比較
  - QCC-021, QCC-022の統計指標
  - Google Sheets の X-AC列統計データ（2025-08-10以降）

  確認質問:
  1. これらのデータを破棄して再計算すべきでしょうか？
  2. それとも「複合オプション有効での比較」として扱いますか？
* 破棄
* さ
再計算して
