...
* ガッチガチにかためてるにもかかわらず、その隙間を縫うように、以下のような事象が発声
...
現在１０回ほどワークフローの開発を行ってるが、ClaudeCodeが必ず暴走するか、コンテキストの読み間違えを起こすか、人間のようにチェックリストを忘れるか、ユーザーの承認を得ないといけないのに勝手に承認を得ず先に進もうとしてます
