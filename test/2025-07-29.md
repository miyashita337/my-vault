...
[この]()のようなinputの複数画像を元にしてそれを抽出された画像がoutput(今回は：C:\AItools\lora\train\yado\tracker-workspace\P1-006-hierarchical\extraction)

②ダッシュボードの内容が何もない状態なんですが、これって今らデータを作るの？グラフもなにもないけど、これは完了してないですよね？
