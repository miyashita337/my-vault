...
私の質問で左右されないでほしいのですが
* 新しいシステムを作成してるとのことですが、これまで利用していたライブラリとかはそのまま再利用するのですか？
...
# 提案
パット見て、ほとんど作り変えに近いように見えるのですが、既存のファイルで不必要なファイルや不必要なmdがあれば整理してほしい
一旦プロエジェクトルート直下にdeprecatedというディレクトリを作って、その中に整理したほうがいいファイルやディレクトリを移動させてほしい
多すぎて人間の目にはどれがどれなのか？今必要なのか？今不必要なのかの判断がつかない
...
なので、やはりある程度人間の目で見て抽出できてるかどうかを知りたいのですが、どうすればいいでしょうか？