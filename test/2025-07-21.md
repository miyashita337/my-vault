...
評価しました
全体的な総括：kaname08_enhanced_system_final/kaname08_0001.jpg
みたにA評価だったのがFになるのをみて、トレードオフみたいな作りなのがまずいのでしょうか？だんだんピーキーに作っていってあるバージョンを境に抽出が失敗するというのが散見します、抽象的で申し訳ないです、この問題に対していいアプローチ方法ってないでしょうか？