...
あれ間違って上書きした？
shakufuku@uss-enterprise:/mnt/c/AItools/segment-anything$ git diff config/google_sheets.json config/google_sheets_auth.json
shakufuku@uss-enterprise:/mnt/c/AItools/segment-anything$

どっちもサンプルファイルになってしまってるけど
